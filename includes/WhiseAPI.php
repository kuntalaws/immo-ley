            ...
            foreach ($filters as $key => $value) {
                ...
                switch ($key) {
                    ...
                    case 'CountryId':
                        ...
                        $request_body['Filter']['CountryIds'] = [intval($value)];

                        break;

                    case 'CountryIds':

                        // Handle array of country IDs

                        $request_body['Filter']['CountryIds'] = is_array($value) ? array_map('intval', $value) : [intval($value)];
